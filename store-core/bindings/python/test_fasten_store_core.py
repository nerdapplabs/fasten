"""
Tests for the Python binding  (store-core/bindings/python/fasten_store_core.py).
...
Run:
    PYTHONPATH=. pytest test_fasten_store_core.py -v
"""
...
try:
    from fasten_store_core import FastenStore, FastenStoreError
    _LIB_AVAILABLE = True
...
pytestmark = pytest.mark.skipif(
    not _LIB_AVAILABLE,
    reason="libfasten_store_core not built — run `cargo build --release --features all`",
)
